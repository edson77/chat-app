...
import {createMessage} from '../../../actions/chatMessage'
const FooterChat = ({userId, dispatch }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        dispatch(createMessage(userId,content))
        setContent("");
    }
    return (
        <>
            <div className="chat-footer pb-3 pb-lg-7 position-absolute bottom-0 start-0">
                ...
                {/* Chat: Form */}
                <form onSubmit={handleSubmit} className="chat-form rounded-pill bg-dark" data-emoji-form="">
                    <div className="row align-items-center gx-0">
                        ...
                        <div className="col">
                            <div className="input-group">
                                <textarea required id="content" value={content} onChange={(e) => handleInputChange(e)} className="form-control px-0" placeholder="Type your message..." rows="1" data-emoji-input="" data-autosize="true" style={{ overflow: "hidden", overflowWrap: "break-word", resize: "none", height: "47px" }}></textarea>
                        ...
                        <div className="col-auto">
                            <button type="submit" className="btn btn-icon btn-primary rounded-circle ms-5">
...
export default connect(mapStateToProps)(FooterChat);